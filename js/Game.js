class Game {
  ...
  car1 = createSprite(width/3 +10,height -300);
  car1.addImage(imgCar1);
  car1.scale = 0.2;
  car2 = createSprite(width/2+300,height-300);
  ...
  this.criarSprites(moedas,15,imgMoeda,0.3);
  this.criarSprites(gasolina,5,imgGasolina,0.05);
  this.criarSprites(obstaculos,10,imgObstaculo1,0.07);
  this.criarSprites(obstaculos,10,imgObstaculo2,0.07);
}
